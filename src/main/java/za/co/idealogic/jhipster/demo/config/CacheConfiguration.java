package za.co.idealogic.jhipster.demo.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, za.co.idealogic.jhipster.demo.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, za.co.idealogic.jhipster.demo.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, za.co.idealogic.jhipster.demo.domain.User.class.getName());
            createCache(cm, za.co.idealogic.jhipster.demo.domain.Authority.class.getName());
