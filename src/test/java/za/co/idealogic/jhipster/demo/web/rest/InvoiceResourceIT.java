...
import za.co.idealogic.jhipster.demo.domain.Customer;
import za.co.idealogic.jhipster.demo.domain.PaymentTerms;
import za.co.idealogic.jhipster.demo.repository.InvoiceRepository;
import za.co.idealogic.jhipster.demo.service.InvoiceService;
...
public class InvoiceResourceIT {
    ...
    public static Invoice createEntity(EntityManager em) {
        ...
        if (TestUtil.findAll(em, PaymentTerms.class).isEmpty()) {
            paymentTerms = PaymentTermsResourceIT.createEntity(em);
            em.persist(paymentTerms);
            em.flush();
        } else {
            paymentTerms = TestUtil.findAll(em, PaymentTerms.class).get(0);
        }
        invoice.setTerms(paymentTerms);
        return invoice;
    }
    /**
    ...
    public static Invoice createUpdatedEntity(EntityManager em) {
        ...
        PaymentTerms paymentTerms;
        if (TestUtil.findAll(em, PaymentTerms.class).isEmpty()) {
            paymentTerms = PaymentTermsResourceIT.createUpdatedEntity(em);
            em.persist(paymentTerms);
            em.flush();
        } else {
            paymentTerms = TestUtil.findAll(em, PaymentTerms.class).get(0);
