...
import { PaymentTermsComponent } from 'app/entities/payment-terms/payment-terms.component';
...
describe('Component Tests', () => {
  describe('PaymentTerms Management Component', () => {
    let comp: PaymentTermsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PaymentTermsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.paymentTerms[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
