...
describe('Service Tests', () => {
  describe('InvoiceLineItem Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new InvoiceLineItem(0, 0, 'AAAAAAA', 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a InvoiceLineItem', async () => {
        ...
        service
          .create(new InvoiceLineItem(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should update a InvoiceLineItem', async () => {
        const returnedFromService = Object.assign(
          {
            quantity: 1,
            description: 'BBBBBB',
      ...
      it('should return a list of InvoiceLineItem', async () => {
        const returnedFromService = Object.assign(
          {
            quantity: 1,
            description: 'BBBBBB',
      ...
      it('should delete a InvoiceLineItem', async () => {
